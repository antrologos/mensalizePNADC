...
| Metric | Value |
|--------|-------|
| **Total rows processed** | 22,850,046 |
| **Unique household-quarters** | 9,598,695 |
| **Month determination rate** | 95.18% |
| **Fortnight determination rate** | 5.89% |
| **Week determination rate** | 1.23% |
| **Processing time** | ~160 seconds |
| **Throughput** | ~175,000 rows/sec |

## Experimental Strategies Summary

| Strategy | Fortnight % | Week % | Execution Time |
|----------|-------------|--------|----------------|
| Strict (baseline) | 5.89% | 1.23% | - |
| + Probabilistic | ~21% | ~0.6% | ~220s |
| + UPA Aggregation | ~22% | ~0.6% | ~15s |
| + Both | **~27.5%** | **~1.9%** | ~235s |
...
|--------|------------|-------|------|
| **Month** | 9,135,906 | 9,598,695 | **95.18%** |
| **Fortnight** | 565,479 | 9,598,695 | **5.89%** |
| **Week** | 117,860 | 9,598,695 | **1.23%** |
...
|----------|-----------|-------------|--------|----------|
| probabilistic | 0.9 | ~21% | ~0.6% | ~221 |
| upa_aggregation | 0.7 | ~22% | ~0.6% | ~15 |
| both | 0.9/0.7 | **~27.5%** | **~1.9%** | ~235 |
