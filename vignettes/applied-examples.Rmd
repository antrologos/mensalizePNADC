...
To reproduce these analyses, you need stacked PNADC microdata spanning multiple quarters. The code below assumes you have already loaded and processed your data. See the [Download and Prepare vignette](download-and-prepare.html) for detailed instructions on data preparation. For a intituitive overview of the mensalization methodology, see the [Getting Started vignette](getting-started.html).
...
### Step 1: Load Your Mensalized Data
...
Monthly aggregates use `weight_monthly` from mensalizePNADC:
