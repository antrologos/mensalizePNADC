...
This is a challenging analysis due to the ~1% weekly determination rate. To increase sample size, we **pool multiple years** (2019, 2022-2024, excluding COVID years) and compare Carnival states to other states. We use **average hours worked** (VD4035) as our indicator, which should show a clear drop during Carnival:
